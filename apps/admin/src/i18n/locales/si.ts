...
export const si: Record<TranslationKey, string> = {
  ...
  'common.openCalendar': 'දින දර්ශනය විවෘත කරන්න',
  'common.time': 'වේලාව',
  ...
  'profile.lastSignIn': 'අවසන් වරට පිවිසුණේ',
  ...
  'profile.confirmBody':
    'ඔබ තෝරාගත් භාෂාව, පෙනුම සහ අකුරු ප්‍රමාණය වෙත console එක මාරු වේ. වෙනස් වන්නේ මෙම පරිගණකය පමණි, සහ ඕනෑම විටෙක නැවත වෙනස් කළ හැක.',
  'profile.saved': 'මනාපයන් යොදන ලදී',
  'profile.savedHint': 'මෙම පරිගණකයෙන් ඊළඟ වර පිවිසෙන විටත් ඒවා එසේම තිබේ.',
  ...
  'appearance.scheme.light': 'ආලෝකමත්',
  'appearance.scheme.dark': 'අඳුරු',
  'appearance.textSize': 'අකුරු ප්‍රමාණය',
  'appearance.textSize.normal': 'සාමාන්‍ය',
  'appearance.textSize.large': 'විශාල',
  ...
  'suppliers.detail.sectionsLabel': 'මෙම සැපයුම්කරුගේ වාර්තාවේ කොටස්',
  'suppliers.detail.tab.overview': 'සාරාංශය',
  'suppliers.detail.tab.money': 'ගෙවීම් සහ ණය',
  'suppliers.detail.tab.income': 'ආදායම',
  'suppliers.detail.tab.notifications': 'දැනුම්දීම්',
  'suppliers.detail.tab.activity': 'ක්‍රියාකාරකම්',
