...
export const ta: Record<TranslationKey, string> = {
  ...
  'common.openCalendar': 'நாட்காட்டியைத் திற',
  'common.time': 'நேரம்',
  'profile.title': 'உங்கள் சுயவிவரம்',
  'profile.subtitle': 'உங்கள் கணக்கு, மற்றும் இந்தக் கன்சோலை நீங்கள் படிக்கும் விதம்',
  'profile.youTitle': 'நீங்கள்',
  'profile.youDescription': 'உங்கள் கணக்கு பற்றி கன்சோல் அறிந்தவை. மாற்றத்திற்கு தொழிற்சாலை நிர்வாகியிடம் கேளுங்கள்.',
  'profile.name': 'பெயர்',
  'profile.email': 'மின்னஞ்சல்',
  'profile.roles': 'பணிப் பாத்திரங்கள்',
  'profile.lastSignIn': 'கடைசியாக உள்நுழைந்தது',
  'profile.firstSignIn': 'இது உங்கள் முதல் அமர்வு',
  'profile.securityTitle': 'பாதுகாப்பு',
  'profile.securityDescription': 'இந்தக் கணக்கு பாதுகாக்கப்படும் விதம்.',
  'profile.mfaOn': 'இரு-படி சரிபார்ப்பு அமைக்கப்பட்டுள்ளது',
  'profile.mfaOff': 'இரு-படி சரிபார்ப்பு அமைக்கப்படவில்லை',
  'profile.mfaOwed': 'உங்கள் பாத்திரத்திற்குத் தேவை — பதிவு செய்ய தொழிற்சாலை நிர்வாகியிடம் மீட்டமைப்பைக் கேளுங்கள்.',
  'profile.mfaOptional': 'உங்கள் பாத்திரத்திற்குத் தேவையில்லை.',
  'profile.securityHint':
    'கடவுச்சொற்களும் இரு-படி சரிபார்ப்பும் தொழிற்சாலை நிர்வாகியால் “பயனர்களும் பாத்திரங்களும்” திரையிலிருந்து மீட்டமைக்கப்படுகின்றன — இங்கிருந்து மாற்ற முடியாது.',
  'profile.save': 'விருப்பங்களைச் சேமி',
  'profile.unsavedHint': 'இன்னும் பயன்படுத்தப்படவில்லை — பயன்படுத்த சேமிக்கவும்.',
  'profile.nothingToSave': 'சேமிக்க ஒன்றுமில்லை.',
  'profile.confirmTitle': 'இந்த விருப்பங்களைப் பயன்படுத்தவா?',
  'profile.confirmBody':
    'நீங்கள் தேர்ந்தெடுத்த மொழி, தோற்றம் மற்றும் எழுத்து அளவுக்கு கன்சோல் மாறும். இந்தக் கணினி மட்டுமே மாறும், எப்போது வேண்டுமானாலும் மாற்றிக்கொள்ளலாம்.',
  'profile.saved': 'விருப்பங்கள் பயன்படுத்தப்பட்டன',
  'profile.savedHint': 'இந்தக் கணினியில் அடுத்த முறை உள்நுழையும்போதும் இவை இருக்கும்.',
  'profile.preferencesTitle': 'இந்தக் கன்சோலை நீங்கள் படிக்கும் விதம்',
  'profile.preferencesDescription': 'உங்களுக்கு மட்டும். இவை மாறுவது வேறு யாருக்கும் தெரியாது.',
  'profile.language': 'மொழி',
  'profile.languageHint': 'கன்சோலின் சொந்த லேபிள்கள். சப்ளையர்களுக்காக எழுதப்பட்ட உள்ளடக்கம் தன் மொழிகளைத் தக்கவைக்கும்.',
  'profile.preferencesScope':
    'உங்கள் கணக்கிற்குப் பதிலாக இந்தக் கணினியில் சேமிக்கப்படுகிறது, எனவே உள்நுழைவுத் திரையிலும் வேலை செய்யும். வேறு இடத்தில் உள்நுழைந்தால் இயல்பிலிருந்து தொடங்கும்.',
  'appearance.scheme': 'தோற்றம்',
  'appearance.scheme.light': 'ஒளிர்',
  'appearance.scheme.dark': 'இருள்',
  'appearance.textSize': 'எழுத்து அளவு',
  'appearance.textSize.normal': 'சாதாரண',
  'appearance.textSize.large': 'பெரிய',
  ...
  'nav.teaPackets': 'தேநீர் பொட்டலங்கள்',
  'nav.banners': 'விளம்பர பேனர்கள்',
  ...
  'dashboard.queue.teaPacketRequests': 'தேநீர் பொட்டலங்கள்',
  'dashboard.queue.inquiries': 'விசாரணைகள்',

  'dashboard.appAdoption': 'செயலி பயன்பாடு',
  'dashboard.appAdoptionHint': 'சப்ளையர்களில் எத்தனை பேர் உண்மையில் இதைப் பயன்படுத்துகிறார்கள்',
  'dashboard.appInstalled': '{{total}} சப்ளையர்களில் {{withApp}} பேர் உள்நுழைந்துள்ளனர்',
  'dashboard.appWithout': '{{count}} பேர் ஒருபோதும் நிறுவவில்லை',
  'dashboard.appDevices': 'அறிவிப்புகளுக்கு {{count}} சாதனங்கள் பதிவு செய்யப்பட்டுள்ளன',
  'dashboard.appRequestShare': 'இந்த மாதம் செயலியில் பதிவான வேண்டுகோள்கள்: {{value}}',
  'dashboard.adoptionTrend': 'செயலி பயன்பாடு, கடந்த 12 மாதங்கள்',
  'dashboard.adoptionTrendHint':
    'கவுண்டரில் அல்லாமல் செயலியில் பதிவான வேண்டுகோள்களின் விகிதம். வேண்டுகோள்கள் இல்லாத மாதம் பூஜ்ஜியம் அல்ல, கோட்டில் ஒரு இடைவெளி.',
  'dashboard.contentHealth': 'உள்ளடக்கம்',
  'dashboard.contentHealthHint': 'செயலி காட்டுவது, யாருக்கும் தெரிவிக்கப்படாதது',
  'dashboard.bannersLive': 'பேனர்கள் இப்போது செயலில்',
  'dashboard.contentClean': 'பின்வாங்கலோ எழுதப்படாததோ எதுவும் இல்லை.',
  'dashboard.content.articlesWithGaps': 'வெளியிடப்பட்ட {{count}} கட்டுரைகள் ஆங்கிலத்திற்குப் பின்வாங்குகின்றன',
  'dashboard.content.bannersExpired': 'வெளியிடப்பட்ட {{count}} பேனர்களின் காலம் முடிந்துவிட்டது',
  'dashboard.content.staticPagesUnwritten': '{{count}} நிலையான பக்கங்கள் ஒருபோதும் எழுதப்படவில்லை',
  ...
  'suppliers.column.app': 'செயலி',
  'suppliers.app.installed': 'உள்நுழைந்துள்ளார்',
  'suppliers.app.none': 'ஒருபோதும் நிறுவவில்லை',
  'suppliers.app.lastSignIn': 'கடைசி {{when}}',
  'suppliers.filter.appAny': 'செயலி: ஏதேனும்',
  'suppliers.filter.appMissing': 'நிறுவவில்லை',
  'suppliers.filter.appInstalled': 'உள்நுழைந்துள்ளார்',
  ...
  'suppliers.detail.sectionsLabel': 'இந்தச் சப்ளையரின் பதிவுப் பிரிவுகள்',
  'suppliers.detail.tab.overview': 'சுருக்கம்',
  'suppliers.detail.tab.money': 'கொடுப்பனவு & கடன்',
  'suppliers.detail.tab.income': 'வருமானம்',
  ...
  'bills.readOnlyNotice':
    'படிக்க மட்டும். பில்கள் தொழிற்சாலையின் சொந்த கன்சோலில் உருவாக்கப்பட்டு வெளியிடப்படுகின்றன; சப்ளையரின் தொலைபேசியில் உள்ள கணக்கு பற்றிய கேள்விக்கு அலுவலகம் பதிலளிக்க இந்தத் திரை உள்ளது.',
  ...
  'config.flagGatesApp': 'இதைச் செயலியிலிருந்து நீக்குகிறது. கன்சோலில் இதற்குப் பின் எதுவும் இல்லை.',
  ...
  'config.flag.enableTeaPackets': 'கிடங்கிலிருந்து தேநீர் பொட்டலங்கள்',
  ...
  'config.flag.enableOnboarding': 'அறிமுகத் திரைகள்',
  'config.flag.enableBiometricLogin': 'கைரேகை / முக உள்நுழைவு',
  'config.flag.enableDarkModeToggle': 'இருண்ட பயன்முறை மாற்றி',
  'config.flag.enableProfileTab': 'சுயவிவரத் தாவல்',
  'config.flag.enableAutoLock': 'தானியங்கிப் பூட்டு',
  ...
  'config.manureProducts': 'சப்ளையர் கேட்கக்கூடிய உரம்',
  'config.manureProductsHint':
    'பெயர், ஒரு மூட்டையில் உள்ள கிலோ, மற்றும் ஒரு மூட்டையின் விலை. கோரிக்கை இந்தப் பட்டியலிலிருந்து விலை நிர்ணயிக்கப்படுகிறது — அலுவலகம் ஒருபோதும் தொகையைத் தட்டச்சு செய்வதில்லை, எனவே சப்ளையர் தமக்கு வசூலிக்கப்பட்டதை இதனுடன் சரிபார்க்கலாம்.',
  'config.manure.name': 'உரத்தின் பெயர்',
  'config.manure.packKg': 'ஒரு மூட்டையில் கிலோ',
  'config.manure.pricePerPack': 'ஒரு மூட்டையின் விலை (ரூ.)',
  'config.manure.remove': '{{name}} நீக்கு',
  'config.manure.example':
    'ஒரு மூட்டை {{pack}}, விலை {{price}}. {{quantity}} கேட்கும் சப்ளையருக்கு 2 மூட்டைகள் வழங்கப்பட்டு {{amount}} செலுத்த வேண்டும்.',
  'config.manure.problem.no-name': 'உரத்திற்கு ஒரு பெயர் தேவை — செயலி அதைப் பட்டியலில் காட்டுகிறது.',
  'config.manure.problem.bad-pack': 'ஒரு மூட்டையில் ஏதாவது இருக்க வேண்டும். பூஜ்ஜியம் கிலோவுக்கு விலை நிர்ணயிக்க முடியாது.',
  'config.manure.problem.negative-price': 'விலை பூஜ்ஜியத்திற்குக் கீழே இருக்க முடியாது.',
  'config.manure.problem.duplicate-name': 'இரண்டு உரங்கள் ஒரே பெயரைக் கொண்டுள்ளன, எனவே கோரிக்கை எதைக் குறிக்கிறது எனச் சொல்ல முடியாது.',
  'config.addManureType': 'ஒரு வகையைச் சேர்',
  'config.savingsRates': 'வழங்குநர் தேர்ந்தெடுக்கக்கூடிய சேமிப்பு வீதங்கள் (கிலோவுக்கு ரூ.)',
  'config.addRate': 'வீதம் ஒன்றைச் சேர்',

  'rates.deduction.title': 'ஒவ்வொரு கணக்கிலிருந்தும் கழிக்கப்படுவது',
  'rates.deduction.description':
    'தொழிற்சாலை நிர்ணயிக்கும் கட்டணங்கள், மற்றும் ஒரு மாதத்தில் கடன் அதிகபட்சம் எவ்வளவு பிடிக்கலாம் என்பது. மாற்றத்திற்கு இரண்டாம் நபர் தேவை.',
  'rates.deduction.customised': 'இந்தத் தொழிற்சாலை நிர்ணயித்தது',
  'rates.deduction.shipped': 'ஒருபோதும் நிர்ணயிக்கப்படவில்லை',
  'rates.deduction.shippedHint':
    'இவை கன்சோலுடன் வந்த எண்கள், இந்தத் தொழிற்சாலையினுடையவை அல்ல — கிலோவுக்கு ரூ. {{transport}} போக்குவரத்து ஒரு தற்காலிக மதிப்பு. யாராவது நிர்ணயிக்கும் வரை, அவை ஒவ்வொரு கணக்கிலும் உள்ளன, யாரும் அவற்றைத் தேர்வு செய்யவில்லை.',
  'rates.deduction.transportPerKg': 'போக்குவரத்து (கிலோவுக்கு ரூ.)',
  'rates.deduction.stamps': 'முத்திரை (ரூ.)',
  'rates.deduction.caps': 'ஒரு மாதத்தில் கடன் பிடிக்கக்கூடிய அதிகபட்சம் (%)',
  'rates.deduction.capsHint':
    'எத்தனை மாதங்களில் திருப்பிச் செலுத்துவது என்பதைச் சப்ளையர் தேர்வு செய்கிறார். நன்றாகக் கொழுந்து கிடைத்த காலத்தில் ஒப்புக்கொண்ட திருப்பிச் செலுத்தலில் மோசமான மாதம் முழுவதுமாக மறைந்துபோவதைத் தடுக்கும் உச்சவரம்பு இது.',
  'rates.deduction.field.transportPerKg': 'கிலோவுக்குப் போக்குவரத்து',
  'rates.deduction.field.stamps': 'முத்திரை',
  'rates.deduction.field.instalmentShares.advance': 'முன்பணத்தின் உச்சவரம்பு',
  'rates.deduction.field.instalmentShares.loan': 'கடனின் உச்சவரம்பு',
  'rates.deduction.field.instalmentShares.manure': 'உரத்தின் உச்சவரம்பு',
  'rates.deduction.propose': 'ஒப்புதலுக்கு அனுப்பு',
  'rates.deduction.reasonHint': 'குறைந்தது 10 எழுத்துகள். ஒப்புதல் அளிப்பவர் முடிவெடுப்பதற்கு முன் இதைப் படிப்பார்.',
  'rates.deduction.needsApproval': 'இது நடைமுறைக்கு வர இரண்டாம் நபர் ஒப்புதல் அளிக்க வேண்டும்.',
  'rates.deduction.nothingChanged': 'எதுவும் மாறவில்லை.',
  'rates.deduction.proposed': 'ஒப்புதலுக்கு அனுப்பப்பட்டது',
  'rates.deduction.proposedHint': 'இன்னும் எதுவும் மாறவில்லை. ஒரு மேலாளர் ஒப்புதல் அளிக்க வேண்டும்.',
  'rates.deduction.proposeFailed': 'எதுவும் அனுப்பப்படவில்லை',
  'rates.deduction.pendingTitle': 'ஒப்புதலுக்குக் காத்திருக்கிறது — {{name}} முன்மொழிந்தார், {{when}}',
  'rates.deduction.approve': 'ஒப்புதல் அளி',
  'rates.deduction.reject': 'நிராகரி',
  'rates.deduction.approved': 'புதிய விகிதங்கள் நடைமுறையில் உள்ளன',
  'rates.deduction.rejectd': 'மாற்றம் நிராகரிக்கப்பட்டது',
  'rates.deduction.decideFailed': 'எதுவும் மாற்றப்படவில்லை',
  'rates.deduction.noteHint': 'நிராகரிக்கத் தேவை. முன்மொழிந்தவர் இதைப் படிப்பார்.',
  'rates.deduction.fourEyes': 'இதை நீங்கள் முன்மொழிந்தீர்கள், எனவே வேறு யாராவது ஒப்புதல் அளிக்க வேண்டும் (BR-501).',
  'rates.deduction.awaitingManager': 'இது நடைமுறைக்கு வர ஒரு மேலாளர் ஒப்புதல் அளிக்க வேண்டும்.',
  'rates.deduction.readOnly': 'கணக்காளர் மட்டுமே இவற்றில் மாற்றத்தை முன்மொழிய முடியும்.',
  'rates.deduction.elsewhere':
    'மற்ற வரிகள் இங்கு நிர்ணயிக்கப்படுவதில்லை. சேமிப்பு சப்ளையருடையது (மாற்றக் கோரிக்கைகள்); தேயிலை, உரம், முன்பணம் ஆகியவை செயலியிலிருந்து கேட்கப்படுகின்றன; முந்தைய கடன் கடந்த மாதத்திலிருந்து வருகிறது. ஒப்புதல் பெற்ற விகிதங்கள் அடுத்த பில் தயாரிப்புக்குப் பொருந்தும், ஏற்கெனவே வெளியிடப்பட்ட மாதத்திற்கு ஒருபோதும் இல்லை.',
  ...
  'config.impact.teaPacketsOutstanding':
    'ரூ. {{count}} மதிப்புள்ள தேநீர் பொட்டலங்கள் வழங்கப்பட்டு இன்னும் ஒரு கணக்கில் கழிக்கப்படவில்லை. இதை நிறுத்தினால் அது மறைந்துவிடும், எனவே இதைச் சேமிக்க முடியாது.',
  'config.impact.teaPacketPolicy.bad-pack':
    'ஒரு பொட்டலத்திற்கு எடை இருக்க வேண்டும். சேமிக்கும் முன் பொட்டல அளவை நிர்ணயிக்கவும்.',
  'config.impact.teaPacketPolicy.negative-price': 'ஒரு பொட்டலத்தின் விலை பூஜ்ஜியத்திற்குக் குறைவாக இருக்க முடியாது.',
  'config.impact.teaPacketPolicy.bad-max':
    'ஒரு வேண்டுகோளுக்கான வரம்பு குறைந்தது ஒரு பொட்டலமாக இருக்க வேண்டும். திட்டத்தை மூட, அதற்குப் பதிலாக அம்சத்தை நிறுத்தவும்.',
  ...
  'config.section.teaPackets': 'தேநீர் பொட்டலங்கள்',
  'config.sectionHint.teaPackets': 'ஒரு பொட்டலம் என்றால் என்ன, அதன் விலை என்ன',
  'config.sectionDescription.teaPackets':
    'கிடங்கு வழங்கும் பொட்டலம், அதன் விலை, மற்றும் ஒரு சப்ளையர் ஒரு முறையில் கேட்கக்கூடிய அதிகபட்சம். ஒரு வேண்டுகோள் அங்கீகரிக்கப்படும்போது வசூலிக்கப்படுவது இந்த விலையே.',
  'config.teaPackets.packGrams': 'பொட்டல அளவு (கிராம்)',
  'config.teaPackets.pricePerPacket': 'ஒரு பொட்டலத்தின் விலை (ரூ.)',
  'config.teaPackets.maxPerRequest': 'ஒரு வேண்டுகோளுக்கு அதிகபட்சப் பொட்டலங்கள்',
  'config.teaPackets.maxHint':
    'இது ஒரு கையிருப்பு வரம்பு, கடன் வரம்பு அல்ல. அதைத் தாண்டிய வேண்டுகோளை வரம்பை விளக்கும் குறிப்புடன் நிராகரிக்கலாம்.',
  'config.teaPackets.flagOff':
    'இந்தத் தொழிற்சாலைக்குத் தேநீர் பொட்டலங்கள் நிறுத்தப்பட்டுள்ளன, எனவே இங்கு எதுவும் இன்னும் செயல்படாது. முதலில் “அம்சங்கள்” பகுதியில் அவற்றை இயக்கவும்.',
  ...
  'teaPackets.subtitle':
    'தொழிற்சாலையின் சொந்த தேநீர் பொட்டலங்கள். செயலியில் கேட்கப்பட்டு, அடுத்த கணக்கில் கழிக்கப்படும்.',
  'teaPackets.column.supplier': 'சப்ளையர்',
  'teaPackets.column.packets': 'பொட்டலங்கள்',
  'teaPackets.column.delivery': 'எப்படிப் பெறுவது',
  'teaPackets.column.amount': 'மதிப்பு',
  'teaPackets.column.age': 'காத்திருப்பு',
  'teaPackets.weight': '{{kg}} கி.கி.',
  'teaPackets.unitPrice': 'ஒன்றுக்கு {{price}}',
  'teaPackets.packetsWithWeight': '{{packets}} பொட்டலங்கள் · {{kg}} கி.கி.',
  'teaPackets.request': 'கேட்கப்பட்டது',
  'teaPackets.supplierNote': 'சப்ளையரின் குறிப்பு',
  'teaPackets.delivery.factoryCollection': 'கிடங்கிலிருந்து பெறுதல்',
  'teaPackets.delivery.transportVehicle': 'சேகரிப்பு வாகனத்தில்',
  'teaPackets.status.pending': 'காத்திருக்கிறது',
  'teaPackets.status.approved': 'அங்கீகரிக்கப்பட்டது',
  'teaPackets.status.rejected': 'நிராகரிக்கப்பட்டது',
  'teaPackets.filter.pending': 'காத்திருக்கிறது',
  'teaPackets.filter.approved': 'அங்கீகரிக்கப்பட்டது',
  'teaPackets.filter.rejected': 'நிராகரிக்கப்பட்டது',
  'teaPackets.filter.allDelivery': 'எந்த முறையும்',
  'teaPackets.decide': 'முடிவு செய்',
  'teaPackets.decideTitle': 'இந்த தேநீர் பொட்டல வேண்டுகோளை முடிவு செய்',
  'teaPackets.decideBody':
    'மதிப்பு சப்ளையரின் அடுத்த பச்சை இலைக் கணக்கிலிருந்து கழிக்கப்படும். அவர்கள் படிப்பது இந்தக் குறிப்பையே.',
  'teaPackets.approve': 'அங்கீகரி',
  'teaPackets.reject': 'நிராகரி',
  'teaPackets.approved': 'வேண்டுகோள் அங்கீகரிக்கப்பட்டது',
  'teaPackets.rejected': 'வேண்டுகோள் நிராகரிக்கப்பட்டது',
  ...
  'teaPackets.fourEyes.title': 'இந்த வேண்டுகோளைப் பதிவு செய்தது நீங்கள்.',
  'teaPackets.fourEyes.body': 'வேறு ஒருவர்தான் இதை முடிவு செய்ய வேண்டும் (BR-501).',
  'teaPackets.alreadyDecided.title': 'ஏற்கெனவே முடிவு செய்யப்பட்டது.',
  'teaPackets.alreadyDecided.body':
    'இந்த வரிசை திறந்திருந்தபோது வேறொரு பயனர் இதை முடிவு செய்துவிட்டார். திரை புதுப்பிக்கப்பட்டது.',
  'teaPackets.problem.title': 'தொழிற்சாலையின் கொள்கைக்கு வெளியே.',
  'teaPackets.problem.no-packets': 'வேண்டுகோள் எந்தப் பொட்டலத்திற்கும் இல்லை.',
  'teaPackets.problem.not-whole': 'கிடங்கு முழுப் பொட்டலங்களை மட்டுமே வழங்குகிறது.',
  'teaPackets.problem.over-max': 'ஒரு வேண்டுகோளுக்கு {{max}} பொட்டலங்களுக்கு மேல்.',
  'teaPackets.noPolicy.title': 'தேநீர் பொட்டல விலை இன்னும் நிர்ணயிக்கப்படவில்லை.',
  'teaPackets.noPolicy.body':
    'இந்த வேண்டுகோள்கள் ஒரு பொட்டலத்திற்கு {{price}} என்ற இயல்பு விலையில் கணக்கிடப்படுகின்றன. தொழிற்சாலையின் சொந்த விலையை “அமைப்பு” பகுதியில் நிர்ணயிக்கவும்.',

  /* ───────────────────────── M11 விளம்பர பேனர்கள் (v2) ───────────────────────── */
  'banners.title': 'விளம்பர பேனர்கள்',
  'banners.subtitle':
    'செயலிக்குள் நுழையும்போது சப்ளையர் காணும் முழு அகல அறிவிப்பு. ஒரு பொத்தான், ஒரு செயல்படும் காலம்.',
  'banners.create': 'புதிய பேனர்',
  'banners.createTitle': 'புதிய பேனர்',
  'banners.createDescription':
    'முதலில் {{language}} மொழியில் எழுதுங்கள். மற்ற மொழிகள் அடுத்த திரையில்.',
  'banners.createConfirm': 'பேனரை உருவாக்கு',
  'banners.createDraftHint':
    'இது வரைவாக உருவாக்கப்படுகிறது. தொழிற்சாலை நிர்வாகி வெளியிடுவார்.',
  ...
  'banners.untitled': 'தலைப்பில்லாத பேனர்',
  'banners.column.title': 'தலைப்பு',
  'banners.column.window': 'செயல்படும் காலம்',
  'banners.column.languages': 'மொழிகள்',
  'banners.searchPlaceholder': 'தலைப்புகளைத் தேடு',
  'banners.complete': 'அனைத்தும் எழுதப்பட்டது',
  'banners.missingCount': '{{count}} மொழிகள் இல்லை',
  'banners.noArtwork': 'படம் இல்லை — செயலி வர்த்தக முத்திரைப் பலகையை வரையும்',
  'banners.noEnd': 'நீக்கும் வரை',
  'banners.lens.all': 'அனைத்து பேனர்கள்',
  'banners.window.scheduled': 'திட்டமிடப்பட்டது',
  'banners.window.live': 'செயலில்',
  'banners.window.expired': 'முடிந்தது',
  'banners.window.backwards': 'முடிவு தொடக்கத்திற்குப் பின் இருக்க வேண்டும்.',
  'banners.status.draft': 'வரைவு',
  'banners.status.published': 'வெளியிடப்பட்டது',
  'banners.status.archived': 'காப்பகப்படுத்தப்பட்டது',
  'banners.noneLive': 'எதுவும் காட்டப்படவில்லை',
  'banners.noneLiveHint': 'இப்போது செயல்படும் காலத்தில் எந்தப் பேனரும் இல்லை.',
  'banners.empty': 'இன்னும் பேனர்கள் இல்லை',
  'banners.emptyHint': 'ஒரு பேனர் என்பது ஒரு பொத்தானுடன் கூடிய ஓர் அறிவிப்பு. முதலாவதை உருவாக்குங்கள்.',
  'banners.field.headline': 'தலைப்பு',
  'banners.field.headlineHint': 'சுருக்கமாக. இது தொலைபேசியில், செயலிக்குள் நுழையும்போது படிக்கப்படுகிறது.',
  'banners.field.body': 'துணை வரி',
  'banners.field.bodyHint': 'கட்டாயமில்லை. ஒரு தலைப்பும் ஒரு பொத்தானும் போதும்.',
  'banners.field.buttonLabel': 'பொத்தானின் பெயர்',
  'banners.field.buttonHint': 'பொத்தானில் என்ன எழுதுவது. அது எங்கே செல்கிறது என்பது கீழே.',
  'banners.field.buttonHintLong':
    'அதிகபட்சம் {{max}} எழுத்துகள் — நீளமான பெயர் சிறிய தொலைபேசியில் வெளியே செல்லும்.',
  'banners.field.startsAt': 'தொடக்கம்',
  'banners.field.endsAt': 'முடிவு',
  'banners.field.endsAtHint': 'நீக்கும் வரை இயங்க வெறுமையாக விடவும்.',
  'banners.action.kind': 'பொத்தான் திறப்பது',
  'banners.action.kindHint':
    'செயலியின் ஒரு திரை, அல்லது செயலியை விட்டு வெளியேறும் இணைப்பு. இரண்டும் செயலி உண்மையில் திறப்பதற்கு எதிராகச் சரிபார்க்கப்படுகின்றன.',
  'banners.action.screen': 'செயலியின் ஒரு திரை',
  'banners.action.url': 'செயலிக்கு வெளியே ஓர் இணைப்பு',
  'banners.action.pathLabel': 'செயலித் திரை',
  'banners.action.pathHint':
    'சிறிய எழுத்துகள், திட்டமோ வினவல் சரமோ இல்லாமல் — எடுத்துக்காட்டாக news/news-1.',
  'banners.action.urlLabel': 'இணைப்பு',
  'banners.action.urlHint': 'https, tel அல்லது mailto மட்டும்.',
  'banners.action.missing': 'பொத்தானுக்குச் செல்ல ஓர் இடம் தேவை.',
  'banners.action.badPath':
    'செயலியால் அந்தப் பாதையைத் திறக்க முடியாது. சிறிய எழுத்துகள், இலக்கங்கள், இடைக்கோடுகள் — சாய்வுக்கோடுகளால் பிரிக்கப்பட்டவை.',
  'banners.action.badUrl': 'செயலி https, tel மற்றும் mailto இணைப்புகளை மட்டுமே திறக்கும்.',
  'banners.action.appSchemeRefused':
    'செயலிக்குள்ளேயே செல்ல “செயலியின் ஒரு திரை” என்பதைப் பயன்படுத்தவும் — செயலி teafactory:// இணைப்புகளை மறுக்கிறது.',
  'banners.action.resolvedScreen': 'பொத்தான் செயலியின் {{path}} திரையைத் திறக்கும்.',
  'banners.action.resolvedUrl': 'பொத்தான் {{url}} ஐத் திறக்கும்.',
  'banners.copyTitle': 'உரை',
  'banners.copyDescription': 'தலைப்பும் பொத்தானின் பெயரும், தொழிற்சாலை எழுதும் ஒவ்வொரு மொழியிலும்.',
  'banners.saveNeedsCopy': 'சேமிப்பதற்கு முன் ஒரு தலைப்பும் பொத்தானின் பெயரும் தேவை.',
  'banners.settingsTitle': 'பொத்தானும் காலமும்',
  'banners.settingsDescription':
    'பொத்தான் செல்லும் இடம், மற்றும் பேனர் சப்ளையர்கள் முன் இருக்கும் காலம். மொழிபெயர்க்கப்படுவதில்லை — எல்லா மொழிகளுக்கும் ஒரே இலக்கு.',
  'banners.saveSettings': 'பொத்தானையும் காலத்தையும் சேமி',
  'banners.settingsSaved': 'பொத்தானும் காலமும் சேமிக்கப்பட்டன',
  'banners.settingsSaveFailed': 'சேமிக்க முடியவில்லை',
  'banners.settingsCurrent': 'சேமிக்கப்பட்டது.',
  'banners.gapNotice':
    '{{languages}} மொழியில் எதுவும் எழுதப்படவில்லை. அந்த மொழிகளில் படிக்கும் சப்ளையர்கள் {{fallback}} உரையைக் காண்பார்கள்.',
  'banners.notLive.scheduledTitle': 'வெளியிடப்பட்டது, ஆனால் இன்னும் காட்டப்படவில்லை.',
  'banners.notLive.scheduledBody': 'செயல்படும் காலம் தொடங்கும்போது தோன்றும்.',
  'banners.notLive.expiredTitle': 'வெளியிடப்பட்டது, ஆனால் முடிந்தது.',
  'banners.notLive.expiredBody': 'செயல்படும் காலம் முடிந்துவிட்டதால் எந்தச் சப்ளையருக்கும் தெரியாது.',
  'banners.lifecycleTitle': 'வெளியீடு',
  'banners.lifecycleDraft': 'ஒரு வரைவு யாருக்கும் தெரியாது.',
  'banners.lifecyclePublished': 'வெளியிடப்பட்டது — செயல்படும் காலத்தில் தோன்றும்.',
  'banners.publish': 'வெளியிடு',
  'banners.unpublish': 'நீக்கு',
  'banners.archive': 'காப்பகப்படுத்து',
  'banners.published': 'பேனர் வெளியிடப்பட்டது',
  'banners.unpublished': 'பேனர் நீக்கப்பட்டது',
  'banners.archived': 'பேனர் காப்பகப்படுத்தப்பட்டது',
  'banners.publishFailed': 'வெளியிட முடியவில்லை',
  'banners.unpublishFailed': 'நீக்க முடியவில்லை',
  'banners.archiveFailed': 'காப்பகப்படுத்த முடியவில்லை',
  'banners.publishedBy': '{{when}} அன்று {{name}} வெளியிட்டார்',
  'banners.publishNeedsAdmin': 'பேனர்களை வெளியிடுவது தொழிற்சாலை நிர்வாகி.',
  'banners.publishNeedsAction':
    'வெளியிடும் முன் பொத்தானைச் சரிசெய்யவும் — செயலி எந்தப் பொத்தானையும் வரையாது.',
  'banners.noDeleteHint': 'பேனர்கள் காப்பகப்படுத்தப்படும், ஒருபோதும் அழிக்கப்படாது.',
  'banners.auditTitle': 'பேனர் வரலாறு',
  'banners.confirm.publishTitle': 'இந்தப் பேனரை வெளியிடவா?',
  'banners.confirm.publishBody': 'ஒவ்வொரு சப்ளையரும் செயலிக்குள் நுழையும்போது ஒருமுறை காண்பார்.',
  'banners.confirm.publishAction': 'வெளியிடு',
  'banners.confirm.unpublishTitle': 'இந்தப் பேனரை நீக்கவா?',
  'banners.confirm.unpublishBody': 'காலம் என்ன சொன்னாலும் உடனே காட்டப்படுவது நிற்கும்.',
  'banners.confirm.unpublishAction': 'நீக்கு',
  'banners.confirm.archiveTitle': 'இந்தப் பேனரைக் காப்பகப்படுத்தவா?',
  'banners.confirm.archiveBody': 'இது பட்டியலிலிருந்து விலகும். எதுவும் அழிக்கப்படவில்லை.',
  'banners.confirm.archiveAction': 'காப்பகப்படுத்து',
  'banners.confirm.publishWithGaps':
    '{{languages}} மொழியில் படிக்கும் சப்ளையர்கள் ஆங்கில உரையைக் காண்பார்கள்.',
  ...
  'suppliers.detail.quickActions': 'விரைவுச் செயல்கள்',
  'suppliers.detail.quickActionsHint':
    'ஒவ்வொன்றும் அந்த வரிசையை இந்தச் சப்ளையருக்கு வடிகட்டித் திறக்கும்.',
