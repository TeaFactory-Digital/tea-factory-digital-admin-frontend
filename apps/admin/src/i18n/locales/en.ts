...
export const en = {
  ...
  'common.openCalendar': 'Open the calendar',
  'common.time': 'Time',
  ...
  'profile.confirmBody':
    'The console will switch to the language, appearance and text size you have chosen. Only this computer changes, and you can change them back at any time.',
  'profile.saved': 'Preferences applied',
  'profile.savedHint': 'They will still be here the next time you sign in on this computer.',
  ...
  'appearance.textSize.normal': 'Normal',
  ...
  'nav.sectionSupport': 'Supplier support',
  ...
  'dashboard.queue.teaPacketRequests': 'Tea packets',
  ...
  'dashboard.appWithout': '{{count}} have never installed it',
  'dashboard.appDevices': '{{count}} devices registered for notifications',
  'dashboard.appRequestShare': 'Requests raised in the app this month: {{value}}',
  'dashboard.adoptionTrend': 'App adoption, last 12 months',
  'dashboard.adoptionTrendHint':
    'Share of requests raised in the app rather than at the counter. A month with no requests is a gap in the line, not a zero.',
  'dashboard.contentHealth': 'Content',
  'dashboard.contentHealthHint': 'What the app is showing that nobody has been told about',
  'dashboard.bannersLive': 'banners live right now',
  'dashboard.contentClean': 'Nothing is falling back or unwritten.',
  'dashboard.content.articlesWithGaps': '{{count}} published articles fall back to English',
  'dashboard.content.bannersExpired': '{{count}} published banners have finished their window',
  ...
  'suppliers.column.app': 'App',
  'suppliers.app.installed': 'Signed in',
  'suppliers.app.none': 'Never installed',
  'suppliers.app.lastSignIn': 'last {{when}}',
  'suppliers.filter.appAny': 'App: any',
  'suppliers.filter.appMissing': 'Has not installed it',
  'suppliers.filter.appInstalled': 'Has signed in',
  ...
  'suppliers.detail.sectionsLabel': 'Sections of this supplier’s record',
  'suppliers.detail.tab.overview': 'Overview',
  'suppliers.detail.tab.money': 'Payout & credit',
  'suppliers.detail.tab.income': 'Income',
  'suppliers.detail.tab.notifications': 'Notifications',
  'suppliers.detail.tab.activity': 'Activity',
  ...
  'bills.readOnlyNotice':
    'Read-only. Bills are generated and published in the factory’s own console; this screen is here so the office can answer a supplier’s question about the account on their phone.',
  ...
  'config.flagGatesApp': 'Removes this from the app. Nothing in the console renders behind it.',
  ...
  'config.flag.enableTeaPackets': 'Tea packets from the store',
  ...
  'config.flag.enableOnboarding': 'Onboarding screens',
  'config.flag.enableBiometricLogin': 'Fingerprint / face sign-in',
  'config.flag.enableDarkModeToggle': 'Dark mode switch',
  'config.flag.enableProfileTab': 'Profile tab',
  'config.flag.enableAutoLock': 'Automatic lock',
  ...
  'teaPackets.subtitle':
    'Packets of the factory’s own tea, asked for in the app and recovered on the next account.',
  'teaPackets.column.supplier': 'Supplier',
  'teaPackets.column.packets': 'Packets',
  'teaPackets.column.delivery': 'How it travels',
  'teaPackets.column.amount': 'Value',
  'teaPackets.column.age': 'Waiting',
  'teaPackets.weight': '{{kg}} kg',
  'teaPackets.unitPrice': '{{price}} each',
  'teaPackets.packetsWithWeight': '{{packets}} packets · {{kg}} kg',
  'teaPackets.request': 'Asked for',
  'teaPackets.supplierNote': 'The supplier’s note',
  'teaPackets.delivery.factoryCollection': 'Collect from the store',
  'teaPackets.delivery.transportVehicle': 'On the collection vehicle',
  'teaPackets.status.pending': 'Waiting',
  'teaPackets.status.approved': 'Approved',
  'teaPackets.status.rejected': 'Rejected',
  'teaPackets.filter.pending': 'Waiting',
  'teaPackets.filter.approved': 'Approved',
  'teaPackets.filter.rejected': 'Rejected',
  'teaPackets.filter.allDelivery': 'Any delivery',
  'teaPackets.decide': 'Decide',
  'teaPackets.decideTitle': 'Decide this tea-packet request',
  'teaPackets.decideBody':
    'The value is deducted from the supplier’s next Green Leaf Account. The note is what they read.',
  'teaPackets.approve': 'Approve',
  'teaPackets.reject': 'Reject',
  'teaPackets.approved': 'Request approved',
  'teaPackets.rejected': 'Request rejected',
  ...
  'teaPackets.fourEyes.title': 'You raised this request.',
  'teaPackets.fourEyes.body': 'Somebody else has to decide it (BR-501).',
  'teaPackets.alreadyDecided.title': 'Already decided.',
  'teaPackets.alreadyDecided.body':
    'Another user decided this while the queue was open. The screen has been refreshed.',
  ...
  /* ───────────────────────── M11 Promo banners (v2) ───────────────────────── */
  'banners.title': 'Promo banners',
  'banners.subtitle':
    'The full-width announcement a supplier sees on the way into the app. One button, one live window.',
  'banners.create': 'New banner',
  'banners.createTitle': 'New banner',
  'banners.createDescription':
    'Write it in {{language}} first. The other languages follow on the next screen.',
  ...
  'banners.column.title': 'Headline',
  'banners.column.window': 'Live window',
  'banners.column.languages': 'Languages',
  ...
  'banners.window.live': 'Live',
  'banners.window.expired': 'Finished',
  'banners.window.backwards': 'The end has to come after the start.',
  'banners.status.draft': 'Draft',
  'banners.status.published': 'Published',
  'banners.status.archived': 'Archived',
  'banners.noneLive': 'Nothing is showing',
  'banners.noneLiveHint': 'No banner is inside its live window right now.',
  'banners.empty': 'No banners yet',
  'banners.emptyHint': 'A banner is one announcement with one button. Create the first one.',
  'banners.field.headline': 'Headline',
  'banners.field.headlineHint': 'Short. It is read on a phone, on the way into the app.',
  'banners.field.body': 'Supporting line',
  'banners.field.bodyHint': 'Optional. A headline and a button is a perfectly good banner.',
  ...
  'banners.action.kind': 'The button opens',
  'banners.action.kindHint':
    'An app screen, or a link that leaves the app. Both are checked against what the app will actually open.',
  'banners.action.screen': 'A screen in the app',
  'banners.action.url': 'A link outside the app',
  'banners.action.pathLabel': 'App screen',
  ...
  'banners.copyDescription':
    'The headline and button label, in each language the factory authors in.',
  ...
  'banners.settingsCurrent': 'Saved.',
  'banners.gapNotice':
    'Nothing written in {{languages}}. Suppliers reading in those languages see the {{fallback}} copy.',
  'banners.notLive.scheduledTitle': 'Published, and not showing yet.',
  'banners.notLive.scheduledBody': 'It appears when the live window opens.',
  'banners.notLive.expiredTitle': 'Published, and finished.',
  ...
  'banners.published': 'Banner published',
  'banners.unpublished': 'Banner taken down',
  'banners.archived': 'Banner archived',
  'banners.publishFailed': 'Could not publish',
  'banners.unpublishFailed': 'Could not take it down',
  'banners.archiveFailed': 'Could not archive',
  ...
  'banners.confirm.publishBody': 'Every supplier sees it once, on the way into the app.',
  'banners.confirm.publishAction': 'Publish',
  'banners.confirm.unpublishTitle': 'Take this banner down?',
  'banners.confirm.unpublishBody': 'It stops showing immediately, whatever the window says.',
  'banners.confirm.unpublishAction': 'Take down',
  'banners.confirm.archiveTitle': 'Archive this banner?',
  'banners.confirm.archiveBody': 'It leaves the list. Nothing is deleted.',
  'banners.confirm.archiveAction': 'Archive',
  'banners.confirm.publishWithGaps':
    'Suppliers reading in {{languages}} will see the English copy.',
  ...
  'suppliers.detail.quickActions': 'Quick actions',
  'suppliers.detail.quickActionsHint': 'Each opens that queue filtered to this supplier.',
