...
export const ta: Record<TranslationKey, string> = {
  ...
  'payouts.noFileExport':
    'இன்னும் வங்கிக் கோப்பு இல்லை. தொழிற்சாலையின் வங்கி ஏற்கும் வடிவம் — SLIPS, CEFTS அல்லது அதன் சொந்த CSV — மற்றும் காசோலைகள் முன்னரே அச்சிடப்பட்ட தாளில் அச்சிடப்படுமா என்பது இன்னும் தீர்க்கப்படாத கேள்வி (§21.17), எனவே சுற்று உங்களுக்குப் பட்டியலையும், மொத்தத்தையும், வங்கி அதை என்ன செய்தது என்று பதிவு செய்ய இடத்தையும் தருகிறது.',
